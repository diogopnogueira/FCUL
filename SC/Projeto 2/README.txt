...
Para manter a segurança dos ficheiros dos utilizadores utilizou-se a encriptação com sucesso nestes. No entanto, tem alguns problemas, 
principalmente no que toca na consistência dos ficheiros. A desencriptação dos ficheiros não está 100% funcional, visto que consegue 
encriptar e os problemas encontram-se na desencriptação.

A encriptação com o MACfile está assegurada ou seja o ficheiro dos utilizadores registados está seguro com palavra passe do administrador.

Juntamente com o projeto seguem os ficheiros de truststore do client, a keystore e o certificado do servidor e os dois ficheiros de policy alterados.
...
de entrada. Este é utilizado para manipular os utilizadores que se encontrem registados no sistema.
